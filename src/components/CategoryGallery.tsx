        ...
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center p-4">
          <div className="relative max-w-5xl w-full">
            <button
              ...
              className="absolute top-4 right-4 text-gray-300 hover:text-orange-500 transition-colors z-10 bg-black/50 rounded-full p-2"
            >
            ...
            <div className="bg-gray-900 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="p-8">
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <h3 className="text-3xl font-bold text-gray-200 mb-2">{selectedImage.title}</h3>
                    <p className="text-gray-400 text-lg mb-2">{selectedImage.description}</p>
                    <p className="text-orange-500 font-medium">{selectedImage.date}</p>
                  </div>
                  <div className="flex space-x-2">
                    <button className="p-3 bg-gray-800 text-gray-300 rounded-lg hover:bg-orange-500 hover:text-white transition-colors">
