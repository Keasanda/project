    ...
    <section id="contact" className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-bold text-gray-200 mb-8">Let's Start a Conversation</h3>
              ...
              {contactInfo.map((item, index) => (
                <div key={index} className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href={item.link} className="text-gray-400 hover:text-orange-500 transition-colors">
                      {item.info}
                    </a>
                  </div>
                </div>
            ...
            <div className="mb-8">
              <h4 className="font-semibold text-gray-200 mb-4">Follow My Work</h4>
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    key={index}
                    href={social.link}
                    className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:bg-orange-500 hover:text-white transition-all duration-300"
                    title={social.name}
                  >
                    {social.icon}
                  </a>
            ...
            <div className="bg-gray-900 border border-gray-700 p-6 rounded-2xl">
              <h4 className="font-semibold text-gray-200 mb-4">Quick Response Promise</h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-600 text-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-gray-800 border border-gray-600 text-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors resize-vertical placeholder-gray-500"
                ></textarea>
              </div>
